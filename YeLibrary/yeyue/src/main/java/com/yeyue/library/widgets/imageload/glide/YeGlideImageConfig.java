 ...
 * 其他操作同理
 */
public class YeGlideImageConfig extends ImageConfig {
    ...
    private BlurTransformation blurTransformation;//高斯模糊
    private Target[] targets;
    private ImageView[] imageViews;
    private boolean isClearMemory;//清理内存缓存
    private boolean isClearDiskCache;//清理本地缓存

    private YeGlideImageConfig(Buidler builder) {
    ...
    public static final class Buidler {
        ...
        public Buidler transformation(BlurTransformation blurTransformation) {
        ...
        public YeGlideImageConfig build() {
            return new YeGlideImageConfig(this);
        }
    }
}
