...
public abstract class BaseUiFragment<P extends IPresenter> extends BaseFragment<P> implements YeBaseUiFragmentView{
    ...
    public View initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View layoutrootView =  inflater.inflate(initView(savedInstanceState), container, false);
        inflater.inflate(getContentViewId(), (LinearLayout) layoutrootView.findViewById(R.id.ye_base_content), true);
        mToolbar = (Toolbar) layoutrootView.findViewById(R.id.ye_toolbar);
        mLlContent = (LinearLayout) layoutrootView.findViewById(R.id.ye_base_content);
        ...
        if(getLoadView()!=null){
            loadService = LoadSir.getDefault().register(layoutrootView, new Callback.OnReloadListener() {
                @Override
