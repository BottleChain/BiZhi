...
public class YeSkinUtils {
    public static void setSkinOnLine(String skinName){
        ...
        SkinCompatManager.getInstance().loadSkin(skinName, null, YeSkinSDCardLoader.YE_SKIN_LOADER_STRATEGY_SDCARD);
    }
    public static void setSkinLocal(String skinName){
